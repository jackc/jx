...
module Jx
  class Transform < Parslet::Transform
    ...
    rule(fn_decl: simple(:fn), ident: simple(:ident), params: simple(:none), stmt_list: sequence(:stmt_list)) { Function.new ident, [], StmtList.new(stmt_list), nil }
    rule(fn_decl: simple(:fn), ident: simple(:ident), params: sequence(:params), stmt_list: sequence(:stmt_list)) { Function.new ident, params, StmtList.new(stmt_list), nil }
    rule(fn_decl: simple(:fn), ident: simple(:ident), params: sequence(:params), return_type: simple(:return_type), stmt_list: sequence(:stmt_list)) { Function.new ident, params, StmtList.new(stmt_list), return_type }
